...
/**
 * Client application for Demonstration purposes, allowing control of robot,
 * and showing map updates and robot status information.
 * 
 * @author Joe Zammit
 *
 */
public class Application implements KeyListener {
	public static void main(String[] args) {
		...
		new Application(host,"Demo Client");
	}
	...
	public Application(String host, String name) {
		...
		try {
			...
			//If connection successful, constructs new robot status window and map window
			new RobotStatus(25, conn);
			new MapImage(new File("mapout.png"), conn, console);
